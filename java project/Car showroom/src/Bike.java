/** This class deals with Bike and thus inherits the Model class */
...
class Bike extends Model
{
    Bike(){
     ...
     Bike(int p,String name,String brand,double price,double discount ){
    ...
    void remove(int n)
    {
        ...
        File inputFile = new File("bike.txt");
